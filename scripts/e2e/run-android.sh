...
e2e_record_property production_endpoint_coverage "https-sentinel-release-manifest-configuration-not-real-production-endpoint"
e2e_record_property artifact_scope "release-derived-android-emulator-debug-test-signed-not-store-signed"
