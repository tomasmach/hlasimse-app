...
| AT-08 | Offline požadavek nezruší zpětně incident. | Nechat deadline projít offline, vytvořit incident, poté synchronizovat; incident zůstane v auditu a přejde na vyřešený až serverovým přijetím. |
