...
export default function DeleteAccountScreen() {
  ...
  const submit = () => {
    ...
    Alert.alert("Trvale smazat účet?", "Server operaci odmítne, pokud má některý z vašich profilů aktivní incident. Pokud pouze hlídáte cizí profil, váš přístup skončí, ale jeho incident zůstane aktivní pro vlastníka a ostatní strážce. Vaše identita v bezpečnostní auditní stopě bude anonymizována.", [
