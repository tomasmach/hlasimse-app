...
const incident = (id: string, profileId: string): AlertIncident => ({ id, profile_id: profileId, profile_name: profileId, deadline_generation: 1, deadline_at: "2026-07-19T10:00:00Z", opened_at: "2026-07-19T10:01:00Z", resolved_at: null, status: "open", acknowledgements: [], last_known_location: null, delivery_status: { state: "pending", attempt_counts: { queued: 1 } } });
